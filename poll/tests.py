...
class QuestionModelTests(TestCase):
    ...
    def test_was_publish_rencently_with_recnt_question(self):
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_three_past_question(self):
        create_question(question_text="Past question 1", days=-30)
        create_question(question_text="Past question 2", days=-1)
        create_question(question_text="Past question 3", days=-5)
        response = self.client.get(reverse('poll:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
...
#     q = QuestionModelTests()
#     q.test_was_publish_recently_with_future_question()